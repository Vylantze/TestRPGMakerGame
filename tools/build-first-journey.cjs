...
for (const [key, definition] of Object.entries(R.maps)) {
    ...
    events[1] = event(1, "Mira • Priestess", 7, 7, "$MiraJourney-v2", 0);
...
actors[1].name = "Aren"; actors[1].characterName = "$ArenJourney-v2"; actors[1].characterIndex = 0; actors[1].profile = "A swordmaster's son and a master mage's pupil. He copies the form of others' skills, then learns to make them his own.";
actors[2].name = "Mira"; actors[2].characterName = "$MiraJourney-v2"; actors[2].characterIndex = 0; actors[2].faceIndex = 7; actors[2].profile = "Aren's childhood friend. A novice priestess setting out on her coming-of-age journey.";
